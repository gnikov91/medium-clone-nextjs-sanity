  ...
  return (
   <main>
    ...
    <article className="max-w-3xl mx-auto p-5">
     ...
     <div className="flex item-content space-x-2">
      <img
     ...
     <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
       <h3 className="test-sm text-yellow-500">Enjoyed this article?</h3>
      ...
      {/* error when validation failed from React Hook */}
...
return {
 ...
 revalidate: 60, // 60 seconds it will update the old cash
}
}